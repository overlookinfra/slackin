...
body.addEventListener('submit', function (ev){
  ...
  invite(channel ? channel.value : null, coc && coc.checked ? 1 : 0, privacy && privacy.checked ? 1 : 0, email.value, gcaptcha_response.value, function (err, msg){
    if (err) {
...
function invite (channel, coc, privacy, email, gcaptcha_response_value, fn){
  request
